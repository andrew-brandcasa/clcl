    ...
    <section id="down" className="py-20 md:py-24 lg:py-32 fade-in-up">
      <div>
        <div className="container max-w-content mx-auto px-6 md:px-8 lg:px-12">
          ...
          <div className="welcome-navigation grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-5xl mx-auto">
            <div className="nav-item" id="space-icon-box">
              <a href="#wine" className="nav-link block p-8 md:p-10 lg:p-12 hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl rounded-lg">
                <div className="nav-icon mb-6">
                ...
                <div className="nav-content space-y-4 text-center">
                  <h3>OUR WINES</h3>
            ...
            <div className="nav-item">
              <a href="#history" className="nav-link block p-8 md:p-10 lg:p-12 hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl rounded-lg">
                <div className="nav-icon mb-6">
            ...
            <div className="nav-item" id="top-space">
              <a href="#venu" className="nav-link block p-8 md:p-10 lg:p-12 hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl rounded-lg">
                <div className="nav-icon mb-6">
